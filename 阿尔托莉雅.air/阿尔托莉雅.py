...
def roundFirst():
    # 阿尔托莉雅的三个技能
    handleSimpleClick([80,580],3);
    handleSimpleClick([160,580],3);
...
#     # 换人
#     handleChangeHeroClick();
#     # 南丁格尔第二技能
#     handleSkadySkillClick([800,580]);
#     # 南丁格尔第三技能
#     handleSimpleClick([888,580],4);
    # 点击攻击
    handleAttackClick();
...
# 选择助战
def checkFriend():
    skady = exists(Template(r"tpl1617097826629.png", record_pos=(0.189, -0.103), resolution=(1280, 720)));
